...
def test_parse_invalid_prefix() -> None:
    with pytest.raises(ValueError):
        parse_packet(b"!DOORX:1=\x00,\x00;2=\x01,\x09;3=\x00,\x01;")


def test_parse_invalid_state_byte() -> None:
    with pytest.raises(ValueError):
        parse_packet(b"!DOORS:1=\x02,\x00;2=\x01,\x09;3=\x00,\x01;")


def test_parse_invalid_voltage() -> None:
    packet = b"!DOORS:1=\x00,\x00;2=\x01,\xFE;3=\x00,\x7F;"
    parsed = parse_packet(packet)
    assert parsed[2].voltage == 254


def test_parse_missing_voltage() -> None:
    with pytest.raises(ValueError):
        parse_packet(b"!DOORS:1=\x00,\x00;2=\x01,;3=\x00,\x01;")


def test_parse_rejects_payload_longer_than_one_voltage_byte() -> None:
    with pytest.raises(ValueError):
        parse_packet(b"!DOORS:1=\x00,\x00\x00;2=\x01,\x09;3=\x00,\x01;")


def test_parse_missing_door() -> None:
    with pytest.raises(ValueError):
        parse_packet(b"!DOORS:1=\x00,\x00;2=\x01,\x09;", door_count=3)


def test_parse_duplicate_door() -> None:
    with pytest.raises(ValueError):
        parse_packet(b"!DOORS:1=\x00,\x00;2=\x01,\x09;2=\x00,\x01;")
